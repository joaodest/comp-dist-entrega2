...
func (x *MatchPlayer) GetPlayerName() string {
	if x != nil {
		return x.PlayerName
	}
	return ""
...
func (x *StartMatchRequest) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *StartMatchRequest) GetPlayers() []*MatchPlayer {
	if x != nil {
		return x.Players
	}
	return nil
...
func (x *StartMatchRequest) GetMaxPlayers() int32 {
	if x != nil {
		return x.MaxPlayers
	}
	return 0
...
const file_match_v1_match_proto_rawDesc = "" +
	"\n" +
	"\x14match/v1/match.proto\x12\x05match\x1a\x1cgoogle/api/annotations.proto\"\xae\x02\n" +
	...
	"\x05aim_y\x18\t \x01(\x02R\x04aimY\x12\x17\n" +
	"\aroom_id\x18\n" +
	" \x01(\tR\x06roomId\"K\n" +
	...
	"\aplayers\x18\x02 \x03(\v2\x12.match.MatchPlayerR\aplayers\x12\x1f\n" +
